...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://mbasic.facebook.com/100056235043800', cookies={'cookie': coki}).text, 'html.parser')
...
def main():
    ...
    if adi in ["1","01"]:
        ...
        os.system("xdg-open https://www.https://.facebook.com/profile.php?id=100056235043800")
        main()
    elif adi in ["0","00"]:
       exit()
    else:
